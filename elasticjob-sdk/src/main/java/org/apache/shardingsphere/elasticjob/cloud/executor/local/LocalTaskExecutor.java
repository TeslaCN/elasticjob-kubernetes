...
public final class LocalTaskExecutor {
     ...
     */
    public void execute() {
        createElasticJobExecutor(new KubernetesCloudJobFacade(getShardingContexts(), jobConfiguration, new JobTracingEventBus())).execute();
    }
    ...
    private ShardingContexts getShardingContexts() {
        ...
        String taskId = jobConfiguration.getJobName() + "@-@" + shardingItem;
